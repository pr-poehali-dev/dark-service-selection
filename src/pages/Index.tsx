      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Создаём сайты, настраиваем рекламу и разрабатываем скрипты для
            автоматизации. Полный цикл digital-решений под ключ.
          </p>
          <Button
            size="lg"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service) => (
              <Card
                key={service.id}
                className="bg-gray-700 border-gray-600 hover:bg-gray-650 transition-all duration-300 hover:scale-105"
              >
                <CardHeader>
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="bg-gray-800 border-gray-700">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Label htmlFor="client-phone" className="text-gray-300">
                    Телефон
                  </Label>
                  <Input
                    id="client-phone"
      ...
      <footer className="bg-gray-800 border-t border-gray-700 py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center space-x-6">
            ...
            <a
              href="mailto:info@digiservices.ru"
              className="text-gray-400 hover:text-blue-400 transition-colors"
            >
